  ...
  try {
    ...
    const out = rows.map(r => {
      ...
      return {
        ...
        scheduleDate: f['Scheduled At'] || '',
        materialDate: f['Assets Confirmed At'] || '',
        productionDate: f['Production Started At'] || '',
        reviewDate: f['Review Started At'] || '',
        rev: f.Revision || 0,
        ...
        link: f.Download || '',
        productionStatus: f['Production Status'] || '',
        orderStatus: f['Order Status'] || f['Production Status'] || '',
